...
public class TestGridSupplier 
{
	...
	private final static String[] 		HARDEST_SUDOKU = 
	{
		"8........",
		"..36.....",
		".7..9.2..",
	...
	private final static String[] SUDOKU_1 =
	{
		".86.741..",
		".7.21.8..",
		"....6....",
	...
	static Grid getSudoku()			{ return new Grid(SUDOKU_1); }
	static Grid getHardest() 		{ return new Grid(HARDEST_SUDOKU); }
